...
QT_MOC_LITERAL(10, 138, 19), // "showingNodesChanged"
QT_MOC_LITERAL(11, 158, 22), // "std::vector<GraphNode>"
QT_MOC_LITERAL(12, 181, 12) // "showingNodes"
    ...
    "show\0showingNodesChanged\0"
    "std::vector<GraphNode>\0showingNodes"
};
...
void MapNodeModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->showingNodesChanged((*reinterpret_cast< std::vector<GraphNode>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MapNodeModel::*)(std::vector<GraphNode> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapNodeModel::showingNodesChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void MapNodeModel::showingNodesChanged(std::vector<GraphNode> _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
