/****************************************************************************
** Meta object code from reading C++ file 'map_channel.h'
**
...
#include <memory>
#include "../../../includes/map/map_channel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'map_channel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 12), // "processClick"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3), // "lat"
QT_MOC_LITERAL(4, 29, 3) // "lon"

    },
    "MapChannel\0processClick\0\0lat\0lon"
};
...
void MapChannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->processClick((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
    }
}
